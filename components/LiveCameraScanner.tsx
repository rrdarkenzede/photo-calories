...
export default function LiveCameraScanner() {
  ...
  const startCamera = async () => {
    try {
      ...
      console.error('Erreur accés caméra:', err);
  ...
  const capturePhoto = useCallback(() => {
    if (!canAddScan()) {
      alert('🚫 Limite de scans quotidiens atteinte!');
      return;
    }
  ...
  return (
    <div className="space-y-6">
      ...
      {!isCameraActive && !capturedImage && (
        <button
          onClick={startCamera}
          className="w-full flex items-center justify-center gap-4 bg-gradient-to-r from-teal-500 to-cyan-600 text-white p-8 rounded-2xl hover:shadow-2xl transition-all"
        >
          <span className="text-5xl">📷</span>
          <div className="text-left">
            <div className="text-2xl font-bold">Activer la caméra</div>
            <div className="text-sm opacity-90">Capture en temps réel avec analyse IA</div>
          </div>
        </button>
      )}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
            <div className="flex items-center justify-center gap-4">
              <button
                ...
                className="p-4 bg-white/20 hover:bg-white/30 rounded-full backdrop-blur-md transition-all"
              >
              ...
              <button
                ...
                className="p-6 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full shadow-2xl hover:scale-110 transition-all"
              >
      ...
      {capturedImage && !analyzing && !showResults && (
        <div className="relative bg-gray-900 rounded-2xl overflow-hidden">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-4 bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-xl font-bold hover:shadow-xl transition-all"
            >
              🔄 Nouveau scan
            </button>
          </div>
